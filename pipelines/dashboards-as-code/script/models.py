...
class FilterOperatorAndValues:
    ...
    def from_dict(data: dict):
        return FilterOperatorAndValues(
            operator=data.get("operator"), values=data.get("values", [])
        )
...
class ChartConfig:
    ...
    def from_dict(data: dict):
        return ChartConfig(
            dashboard_chart=data.get("dashboardChart"),
            chart_layout=ChartLayout.from_dict(data.get("chartLayout", {})),
...
class DashboardFilter:
    ...
    def from_dict(data: dict):
        return DashboardFilter(
            ...
            is_standard_time_range_filter=data.get("isStandardTimeRangeFilter"),
    ...
    def to_dict(self):
        return {
            "id": self.id,
            "dataSource": self.data_source.value if self.data_source else None,
            ...
            "isStandardTimeRangeFilter": self.is_standard_time_range_filter,
            "isMandatory": self.is_mandatory,
            "isStandardTimeRangeFilterEnabled": self.is_standard_time_range_filter_enabled,
        }
...
class DashboardDefinition:
    ...
    def from_dict(data: dict):
        return DashboardDefinition(
            filters=[
                DashboardFilter.from_dict(item) for item in data.get("filters", [])
            ],
            fingerprint=data.get("fingerprint"),
            charts=[ChartConfig.from_dict(item) for item in data.get("charts", [])],
        )
...
class DashboardUserData:
    ...
    def from_dict(data: dict):
        return DashboardUserData(
            last_viewed_time=data.get("lastViewedTime"), is_pinned=data.get("isPinned")
        )

    def to_dict(self):
        return {"lastViewedTime": self.last_viewed_time, "isPinned": self.is_pinned}
...
class NativeDashboard:
    def __init__(
        ...
        create_user_id: str,
        update_user_id: str,
        dashboard_user_data: DashboardUserData,
        etag: str,
    ...
    def from_dict(data: dict):
        return NativeDashboard(
            ...
            definition=DashboardDefinition.from_dict(data.get("definition", {})),
            ...
            etag=data.get("etag"),
            access=DashboardAccess(data.get("access")) if data.get("access") else None,
        )
