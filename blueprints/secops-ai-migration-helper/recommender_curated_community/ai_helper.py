...
def generate_curated_rules_recommendation(input_rule, curated_rules):
    ...
    response_schema = {
        ...
        "properties": {
            ...
            "curated rules": {"type": "string"},
            "curated rules coverage": {"type": "string"},
            "curated rationale": {"type": "string"},
        },
    }
...
def generate_community_rules_recommendation(input_rule, all_community_rules):
    ...
    response_schema = {
        ...
        "properties": {
            ...
            "title": {"type": "string"},
            "description": {"type": "string"},
            "community rules": {"type": "string"},
            "community rules coverage": {"type": "string"},
            "community rationale": {"type": "string"},
        },
    }
